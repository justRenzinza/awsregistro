...
function mapClienteFromApi(row: any): ClienteBase {
    ...
    const codigo = Number(base?.id ?? base?.codigo ?? id);  // ✅ ADICIONADO - usa o id como código
    ...
    return { id, codigo, nome, idStatus, status };  // ✅ RETORNA codigo
}
...
export default function ControleDeSistemaPage() {
    ...
    const filtered = useMemo<ControleSistema[]>(() => {
        ...
        let data = rows.filter((r) =>
            [
                String(codigoCliente(r.clienteId)),  // ✅ ADICIONADO
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* POPUP (mantenho igual, não precisa mexer) */}
            {editingId !== null && (
